...
# This code will extract a subset of reads from gzipped fastq files and output them to new subset gzipped fastq files to allow for faster script development
